	...
	if ( current_user_can( 'pmpro_membershiplevels' ) ) {
		$wp_admin_bar->add_menu(
			array(
				...
				'href'   => get_admin_url(
					null,
					'/admin.php?page=pmpro-membershiplevels'
				),
			)
		);
	}
	...
	if ( current_user_can( 'pmpro_pagesettings' ) ) {
		$wp_admin_bar->add_menu(
			array(
				...
				'href'   => get_admin_url(
					null,
					'/admin.php?page=pmpro-pagesettings'
				),
			)
		);
	}
	...
	if ( current_user_can( 'pmpro_paymentsettings' ) ) {
		$wp_admin_bar->add_menu(
			array(
				...
				'href'   => get_admin_url(
					null,
					'/admin.php?page=pmpro-paymentsettings'
				),
			)
		);
	}
	...
	if ( current_user_can( 'pmpro_emailsettings' ) ) {
		$wp_admin_bar->add_menu(
			array(
				...
				'href'   => get_admin_url(
					null,
					'/admin.php?page=pmpro-emailsettings'
				),
			)
		);
	}
	...
	if ( current_user_can( 'pmpro_advancedsettings' ) ) {
		$wp_admin_bar->add_menu(
			array(
				...
				'href'   => get_admin_url(
					null,
					'/admin.php?page=pmpro-advancedsettings'
				),
			)
		);
	}
	...
	if ( current_user_can( 'pmpro_memberslist' ) ) {
		$wp_admin_bar->add_menu(
			array(
				...
				'href'   => get_admin_url(
					null,
					'/admin.php?page=pmpro-memberslist'
				),
			)
		);
	}
	...
	if ( current_user_can( 'pmpro_memberslist' ) ) {
		$wp_admin_bar->add_menu(
			array(
				...
				'href'   => get_admin_url(
					null,
					'/admin.php?page=pmpro-memberslisttable'
				),
			)
		);
	}
	...
	if ( current_user_can( 'pmpro_discountcodes' ) ) {
		$wp_admin_bar->add_menu(
			array(
				...
				'href'   => get_admin_url(
					null,
					'/admin.php?page=pmpro-discountcodes'
				),
			)
		);
	}
